...
PORT=53854
UUID=673d2e24-4a43-40df-bef3-ff3fba64399a
WebPage=https://bing.com
CaddyConfig=https://raw.githubusercontent.com/ xetgn /sunny/main/etc/Caddyfile
XRayConfig=https://raw.githubusercontent.com/xetgn /sunny/main/etc/xray.json
